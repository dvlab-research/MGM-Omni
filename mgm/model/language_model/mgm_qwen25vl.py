...
from mgm.model.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLModel
...
class MGMConfig(Qwen2_5_VLConfig):
    model_type = "MGMQwen25VL"

class MGMQwen25VLModel(MGMMetaModel, Qwen2_5_VLModel):
    config_class = MGMConfig
    
    def __init__(self, config: Qwen2_5_VLConfig):
        super(MGMQwen25VLModel, self).__init__(config)


class MGMQwen25VLForCausalLM(Qwen2ForCausalLM, MGMMetaForCausalLM):
    config_class = MGMConfig

    def __init__(self, config):
        super(Qwen2ForCausalLM, self).__init__(config)
        self.model = MGMQwen25VLModel(config)
    ...
    def generate(
        ...
        **kwargs,
        ...
        return super().generate(
            position_ids=position_ids,
            attention_mask=attention_mask,
            inputs_embeds=inputs_embeds.to(device=self.model.device),
            rope_deltas=rope_deltas,
            **kwargs
        )
...
AutoConfig.register("MGMQwen25VL", MGMConfig)
AutoModelForCausalLM.register(MGMConfig, MGMQwen25VLForCausalLM)